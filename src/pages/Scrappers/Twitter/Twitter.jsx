    ...
    return (
        <div className='phonescrap'>
            ...
            <div className='phonebuttons' >
                <button onClick={handleTwitterProfile} style={{ width: "200px"}}>Get Twitter Profile</button>
                <button onClick={handleTwitterTweets} style={{ width: "200px" }}>Get Tweets</button>
                <button onClick={downloadTwitterProfile} style={{ width: "200px" }}>Download Twitter Profile</button>
                <button onClick={downloadTwitterTweets} style={{ width: "200px" }}>Download Twitter Tweets</button>
                <button onClick={getHateSpeechRating} style={{ width: "200px" }}>Get Hate Speech Rating</button>
            </div>
            <hr />
